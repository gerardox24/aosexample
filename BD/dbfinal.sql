...
INSERT INTO `area` VALUES (1,'SISTEMAS'),(2,'SOFTWARE'),(3,'CIENCIA DE LA COMPUTACION');
...
CREATE TABLE `empleado` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_departamento_idx` (`idpais`),
  KEY `fk_ciudad_idx` (`idarea`),
...
INSERT INTO `pais` VALUES (1,'PERU'),(2,'ARGENTINA'),(3,'BRASIL');
...
-- Dump completed on 2017-06-22  9:40:59
